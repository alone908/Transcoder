...
<div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav side-nav">
        ...
        <li class="<?php if($page === 'rm_brancheditor.php') echo 'active'; ?>"><a  id="rm_brancheditor_href" href="rm_brancheditor.php?rulesetid=<?php echo $current_ruleset_id;?>"><i class="fa fa-tree"></i>&nbsp;Branch Editor</a></li>
