...
/* PUBLIC METHODS ****************************************************************************** */
	...
	public function initFromConfig() {
		...
		$this->rootDir = "/Users/Chung/Sites/CardTranscoder/uploadfiles/";
...
/* PROTECTED METHODS *************************************************************************** */
	...
	protected function _viewHeader() {
		...
		if(!$this->hideTitleBar) print "<div id=\"$this->_titleCont\" class=\"fmTH1\" style=\"height:33px; overflow:hidden\"></div>\n";
