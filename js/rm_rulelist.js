...
$(document).ready(function () {
    ...
    $('#rule-list-table-main > tbody > tr').on('click', function (e) {
        select_rule(e, $(this));
    })
    $('#rule-list-table-sub > tbody > tr').on('click', function (e) {
        select_rule(e, $(this));
    })

    $('.del_rule_btn').on('click', function (e) {
        $('#del_rule').data('rulesetid', $(this).data('rulesetid'));
    })
    $('#del_rule').on('click', function (e) {
        del_rule($(this).data('rulesetid'));
    })
    ...
    $('#clone_rule').on('click', function (e) {
        clone_rule($(this).data('rulesetid'));
    })
    ...
    $('#save_rule_name').on('click', function (e) {
        edit_rule_name($(this).data('rulesetid'));
    })
