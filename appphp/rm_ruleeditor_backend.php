  ...
  case 'save_rule_table':
    ...
    foreach ($_POST['ruleTable'] as $key => $rule_row) {
      ...
      switch ($rule_row['op']) {
        ...
        $Subject = 'RuleSet_'.$_POST['rulesetid'].'_'.$rule_row['LineNumber'];
        ...
        '".$Subject."','".$content."','".$rule_row['Exp']."',".$rule_row['Length'].",'".$rule_row['DataCoding']."','".$rule_row['LSB']."','".$rule_row['UnixTime']."','".$rule_row['TranscodeRule']."','".$localTime."',
        'false')";
